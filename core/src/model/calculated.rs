...
pub struct Calculated {
    ...
    pub thermal_shift_east_m: f32,
    pub thermal_shift_north_m: f32,
    pub thermal_shift_distance: Length,
    pub thermal_shift_confidence: f32,
    pub thermal_shift_valid: bool,
    pub frequency: u16,
    pub continuous: bool,
    pub gain: i8,
...
impl Default for Calculated {
    ...
    fn default() -> Self {
        Calculated {
            ...
            thermal_shift_east_m: 0.0,
            thermal_shift_north_m: 0.0,
            thermal_shift_distance: 0.0.m(),
            thermal_shift_confidence: 0.0,
            thermal_shift_valid: false,
            frequency: 500,
            continuous: false,
            gain: 2,
